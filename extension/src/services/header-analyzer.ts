...
const HEADER_DEFINITIONS: Omit<SecurityHeader, "present">[] = [
  {
    name: "Strict-Transport-Security",
    severity: "high",
    recommendation: "Configure HSTS to force HTTPS connections",
    description:
  ...
  },
  {
    ...
    severity: "high",
    recommendation: "Configure CSP to restrict script execution sources",
    description:
      "Prevents XSS and data injection attacks by restricting resource loading",
  },
  {
  ...
  },
  {
    ...
    severity: "low",
    recommendation: "Set Referrer-Policy to limit referrer information",
    description: "Controls how much referrer information is shared",
  },
  {
    name: "Permissions-Policy",
    severity: "low",
    recommendation: "Configure Permissions-Policy to restrict feature access",
  ...
  },
  {
    ...
    severity: "low",
    recommendation: "Set COEP to require-corp",
    description:
